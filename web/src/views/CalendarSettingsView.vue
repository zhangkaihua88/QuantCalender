...
<template>
  <div class="page-head"><div><p class="eyebrow">CALENDAR SUBSCRIPTION</p><h1>个人日历提醒</h1><p class="subtitle">生成专属订阅地址后，可加入 Google、Outlook 或 Apple Calendar。地址等同于访问凭证，请勿转发。</p></div></div>
  <div class="panel-grid">
    <section class="card card-body stack">
      ...
      <div class="inline">
        ...
        <button v-if="exists" class="button danger" @click="revoke"><Trash2 :size="17" />撤销订阅</button>
      </div>
    </section>

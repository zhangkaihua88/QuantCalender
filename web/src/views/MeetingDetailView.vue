...
<template>
  ...
  <div v-else>
    <div class="page-head"><div><p class="eyebrow">MEETING DETAILS</p><h1>{{ meeting.title }}</h1><p class="subtitle">{{ meeting.summary }}</p></div><span class="status" :class="displayStatus">{{ statusText }}</span></div>
